...
class QPointCloudScene : public QOpenGLWidget, protected QOpenGLFunctions
{
    Q_OBJECT
public:
    ...
    QPointCloudScene(const QString& plyFilePath);
    ~QPointCloudScene();
...
private:
    ...
    QSharedPointer<QPointCloudCamera> _currentCamera;
