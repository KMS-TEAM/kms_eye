#include "QOpenGLRender/QPlyLoader.h"

QPlyLoader::QPlyLoader()
{

}

float* QPlyLoader::calculateNormal( float *coord1, float *coord2, float *coord3 )
{
...
int QPlyLoader::load(char* filename)
{
