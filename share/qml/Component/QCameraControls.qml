...
Rectangle {
    ...
    Component.onCompleted: {
        if(camera){
            actualStuff.createObject(cameraControls)
        }
    }
    ...
    Component {
        ...
        GridLayout{
            ...
            Label{
                text: cameraControls.camera.azimuth.toFixed(2)
            }
            ...
            Label {
                text: cameraControls.camera.elevation.toFixed(2)
            }
            ...
            Label {
                text: cameraControls.camera.distance.toFixed(2)
            }
        }
    }
}
